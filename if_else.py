import random
drinks = ["beer", "wine", "whiskey", "campari", "tequila", "rum", "gin tonic", "rakia", "vodka", "martini", "sangria", "rum"]
try:
    ...
    if age < 0 or age > 130:
        ...
        print("I am sorry, you are too young to play this drinking game everywhere in the world")
